...
class HelpersOnCheck:
    ...
    @staticmethod
    @allure.step('check key in the response')
    ...
    @staticmethod
    @allure.step('check success is present')
    ...
    @staticmethod
    @allure.step('check user field in reponse')
    ...
    @staticmethod
    @allure.step('check user data after registration/authorisation')
    ...
    @staticmethod
    @allure.step('check response after placing an order')
    ...
    @staticmethod
    @allure.step('check ingredients by types')
    ...
    @staticmethod
    @allure.step('check response for getting ingredients list')
    ...
    @staticmethod
    @allure.step('check order info in response')
    ...
    @staticmethod
    @allure.step('check orders in response')
    ...
    @staticmethod
    @allure.step('check total and Totaltoday in response')
